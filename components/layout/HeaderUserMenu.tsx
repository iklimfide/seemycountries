...
export function HeaderUserMenu({ username, displayName, avatarUrl }: HeaderUserMenuProps) {
  ...
  return (
    <div className="relative" ref={rootRef}>
      ...
      {open && (
        <div
          role="menu"
          className="absolute right-0 top-full z-50 mt-2 w-56 overflow-hidden rounded-xl border border-slate-700 bg-slate-900 py-1 shadow-xl"
        >
